...
public class robotSim {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(new robotSim().answer(commands, obstacles));
    }

    public int answer(int[] commands, int[][] obstacles) {
        int r = 0;
        int wtf = 0;
        int x = 0, y = 0, d = 1;
            ...
            if (commands[i] == -1) {
                ...
                if (d == 1) {
                    for (int j = 0; j < commands[i]; j++) {
                        for (int kk = 0; kk < obstacles.length; kk++) {
                            if (x == obstacles[kk][0] && y + 1 == obstacles[kk][1]) {
                                wtf = 1;
                                break;
                            }
                        }
                    ...
                    for (int j = 0; j < commands[i]; j++) {
                        for (int kk = 0; kk < obstacles.length; kk++) {
                            if (x + 1 == obstacles[kk][0] && y == obstacles[kk][1]) {
                                wtf = 1;
                                break;
                            }
                        }
        ...
        r = (int) Math.pow(x, 2) + (int) Math.pow(y, 2);
        return r;
    }
}